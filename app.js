...
// const mainSliderDiv = document.getElementById('main-image-slider');
// selected image 
let sliders = [];
...
const createSlider = () => {
  ...
  const inputTime = document.getElementById('doration').value;
  let duration = Math.abs(inputTime * 1000) || 1000;
...
// sliderBtn.addEventListener("keyup", function (event) {
